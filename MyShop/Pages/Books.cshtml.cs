...
namespace MyShop.Pages
{
    ...
    public class BooksModel : PageModel
    {
        ...
        private readonly int pageSize = 5; //define the books per page
        ...
        public void OnGet()
        {
            ...
            if (requestPage != null)
            {
                try
                {
                    page = int.Parse(requestPage);//convert the chosen page into an int as it is a string upon retrieval
                }
                catch (Exception ex)
                {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    //to indicate the pagination feature, we account for the Search criteria
                    ...
                    //account for title/author input
